...
@app.callback(
    [Output("landing-selection", "value"), Output("suggestions", "options"), Output("suggestions", "value")],
...
def update_list(suggestion_values, selected_value, landing_options, suggestions_options):
    ...
    return updated_selected_values, suggested_options, updated_suggestion_values
